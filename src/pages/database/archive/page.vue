...
const columns: Column<ArchiveRecord>[] = [
  ...
  { key: "originalSize", title: "原始大小", className: "font-mono" },
  { key: "compressedSize", title: "压缩后", className: "font-mono" },
  { key: "ratio", title: "压缩率", className: "font-mono" },
  { key: "archivedAt", title: "归档时间", className: "font-mono text-muted-foreground" },
